<!DOCTYPE html>
<!-- saved from url=(0037)https://projects.verou.me/prefixfree/ -->
...
@font-face {
	font-family: Arvo;
	src: url("https://projects.verou.me/prefixfree/css/../fonts/Arvo-Regular.ttf") format('truetype');
}

@font-face {
	font-family: Arvo;
	font-weight: bold;
	src: url("https://projects.verou.me/prefixfree/css/../fonts/Arvo-Bold.ttf") format('truetype');
}
...
body {
	...
	padding: 2em 4em;
	margin: auto;
	background: url("https://projects.verou.me/prefixfree/css/../img/noise.png") white;
	background: url("https://projects.verou.me/prefixfree/css/../img/raisedfist.png") bottom right no-repeat,
		linear-gradient(90deg, rgba(255,255,255,0) 10%, white),
		url("https://projects.verou.me/prefixfree/css/../img/noise.png") white;
...
hgroup {
	...
	hgroup > h1:before {
		content: url("https://projects.verou.me/prefixfree/css/../img/logo.svg");
		display: block;
		margin: auto;
	}
...
<link rel="shortcut icon" href="https://projects.verou.me/prefixfree/img/favicon.png">
<script src="./Prefix free_ Break free from CSS vendor prefix hell!_files/prefixfree.js.다운로드"></script>
<style>
	body {
...
<script charset="utf-8" src="./Prefix free_ Break free from CSS vendor prefix hell!_files/button.63c51c903061d0dbd843c41e8a00aa5a.js.다운로드"></script></head>
<body class="home">
...
<a href="https://github.com/LeaVerou/prefixfree" target="_blank" class="github-ribbon"><img src="./Prefix free_ Break free from CSS vendor prefix hell!_files/forkme_right_gray_6d6d6d.png" alt="Fork me on GitHub"></a>
...
<nav>
	Learn more:<ul>
		<li><a href="https://projects.verou.me/prefixfree/#">Home</a></li>
		<li><a href="https://projects.verou.me/prefixfree/#test-drive">Test drive</a></li>
		<li><a href="https://projects.verou.me/prefixfree/#faq">FAQ</a></li>
		<li><a href="https://projects.verou.me/prefixfree/#plugins">Plugins</a></li>
	</ul>
</nav>

<blockquote cite="./Prefix free_ Break free from CSS vendor prefix hell!_files/124618575263711232">
	<p>“[-prefix-free is] fantastic, top-notch work! Thank you for creating and sharing it.”</p>
	— <a href="./Prefix free_ Break free from CSS vendor prefix hell!_files/124618575263711232" target="_blank">Eric Meyer</a>
</blockquote>
...
<section id="features">
	...
	<ul class="features">
		...
		<li>Takes care of <strong>new</strong> <code>&lt;link&gt;</code> or <code>&lt;style&gt;</code> elements, <code>style</code> attribute changes and CSSOM changes (<a href="https://projects.verou.me/prefixfree/#dynamic-dom">requires plugin</a>)</li>
		<li>Lets <strong>jQuery</strong>’s <code>.css()</code> method get and set unprefixed properties (<a href="https://projects.verou.me/prefixfree/#jquery">requires plugin</a>)</li>
	</ul>
</section>
<section id="limitations">
	...
	<ul class="drawbacks">
		...
		<li>Unprefixed linked stylesheets won’t work <strong>locally</strong> in Chrome and Opera. <a href="https://projects.verou.me/prefixfree/#local-xhr">You can change that for yourself</a> though.</li>
...
<section id="demo">
	<h1>Demo?</h1>
	<p>Check <a href="https://projects.verou.me/prefixfree/css/style.css">this page’s stylesheet</a> ;-)</p>
	<p>You can also visit the <a href="https://projects.verou.me/prefixfree/#test-drive">Test Drive</a> page, type in any code you want and check out how it would get prefixed for the current browser.</p>
</section>
...
<script src="./Prefix free_ Break free from CSS vendor prefix hell!_files/index.js.다운로드"></script>

<iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" style="position: static; visibility: visible; width: 60px; height: 20px;" title="Twitter Tweet Button" src="./Prefix free_ Break free from CSS vendor prefix hell!_files/tweet_button.96fd96193cc66c3e11d4c5e4c7c7ec97.en.html"></iframe>
<script src="./Prefix free_ Break free from CSS vendor prefix hell!_files/widgets.js.다운로드"></script>

<script>var _gaq = [['_setAccount', 'UA-25106441-4'],['_trackPageview']];</script>
<script src="./Prefix free_ Break free from CSS vendor prefix hell!_files/ga.js.다운로드" async=""></script>



<iframe scrolling="no" frameborder="0" allowtransparency="true" src="./Prefix free_ Break free from CSS vendor prefix hell!_files/widget_iframe.96fd96193cc66c3e11d4c5e4c7c7ec97.html" title="Twitter settings iframe" style="display: none;"></iframe><iframe id="rufous-sandbox" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" style="position: absolute; visibility: hidden; display: none; width: 0px; height: 0px; padding: 0px; border: none;" title="Twitter analytics iframe" src="./Prefix free_ Break free from CSS vendor prefix hell!_files/saved_resource.html"></iframe></body></html>